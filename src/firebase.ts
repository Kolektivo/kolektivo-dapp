...
import { collection, endAt, getDocs, getFirestore, limit, orderBy, query, startAt, where, writeBatch } from 'firebase/firestore/lite';
import { initializeApp } from 'firebase/app';

export const seed = async (timeStamp: Date) => {
