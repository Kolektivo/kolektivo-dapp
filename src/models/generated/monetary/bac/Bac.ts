...
export interface BacInterface extends utils.Interface {
  functions: {
  ...
  events: {
    ...
    "BadgerUpdated(address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "BadgerUpdated"): EventFragment;
...
export interface BadgerUpdatedEventObject {
  badgerAddress: string;
}
export type BadgerUpdatedEvent = TypedEvent<[string], BadgerUpdatedEventObject>;

export type BadgerUpdatedEventFilter = TypedEventFilter<BadgerUpdatedEvent>;
...
export interface Bac extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BacInterface;
  ...
  filters: {
    ...
    "BadgerUpdated(address)"(badgerAddress?: null): BadgerUpdatedEventFilter;
    BadgerUpdated(badgerAddress?: null): BadgerUpdatedEventFilter;
