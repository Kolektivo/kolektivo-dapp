...
import type { Geonft, GeonftInterface } from "../Geonft";
...
export class Geonft__factory {
  ...
  static createInterface(): GeonftInterface {
    return new utils.Interface(_abi) as GeonftInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): Geonft {
    return new Contract(address, _abi, signerOrProvider) as Geonft;
  }
}
