...
export interface KolektivoCuracaoGuilderTokenInterface extends utils.Interface {
  functions: {
    ...
    "initialize(string,string,uint8,address,uint256,uint256,address[],uint256[],string)": FunctionFragment;
...
export interface KolektivoCuracaoGuilderToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: KolektivoCuracaoGuilderTokenInterface;
  ...
  functions: {
    ...
    initialize(
      ...
      initialBalanceAddresses: PromiseOrValue<string>[],
      initialBalanceValues: PromiseOrValue<BigNumberish>[],
