...
export class BrowserStorageService {
  ...
  private get<T = any>(storage: any, key: string, defaultValue: any = null, version?: string): T {
  ...
  public lsGet<T = any>(key: string, defaultValue: any = null, version?: string): T {
  ...
  public ssGet<T = any>(key: string, defaultValue: any = null, version?: string): T {
