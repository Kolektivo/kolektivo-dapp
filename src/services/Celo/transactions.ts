...
import { BigNumber, BigNumberish, BytesLike, Transaction, constants, providers, utils } from 'ethers';
...
export const celoAllowedTransactionKeys: Record<string, boolean> = {
  chainId: true,
  data: true,
  gasLimit: true,
  gasPrice: true,
...
// Need to override to use the celo tx prop whitelists above
export function parseCeloTransaction(rawTransaction: utils.BytesLike): CeloTransaction {
