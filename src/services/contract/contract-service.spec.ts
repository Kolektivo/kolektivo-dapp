...
import { CacheService, ContractService, IContractService, ITokenService, TokenService, toWei } from 'services';
...
describe('contracts-service.ts', () => {
  it('transfers a token', async () => {
    ...
    const token = tokenService.getTokenContract(testTokenAddress) as Erc20;
